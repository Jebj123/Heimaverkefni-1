...
export function Form() {
  ...
  <CardContent className="grid grid-cols-1">
    ...
    <Input className="bg-white" placeholder="First Name" value={firstName} onChange={(e) => setFirstName(e.target.value)}/>
    <Input className="bg-white" placeholder="Last Name" value={lastName} onChange={(e) => setLastName(e.target.value)}/>
    <Input className="bg-white" placeholder="Email" value={email} onChange={(e) => setEmail(e.target.value)}/>
    <Input className="bg-white" placeholder="Phonenumber" value={phoneNumber} onChange={(e) => setPhoneNumber(e.target.value)}/>
